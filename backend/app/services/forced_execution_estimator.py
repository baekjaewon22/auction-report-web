...
def build_eviction_cost_values(data: dict) -> dict:
    ...
    myungsung_execution_cost = int(cost["proposedPrice"])
    cost_plus_total = ATTORNEY_FEE + normal_execution_cost

    return {
        "attorney_fee": ATTORNEY_FEE,
        "normal_execution_cost": normal_execution_cost,
        "myungsung_execution_cost": myungsung_execution_cost,
        "flat_total": myungsung_execution_cost,
        ...
        "myungsung_execution_cost_won": _format_won_with_space(myungsung_execution_cost),
        "eviction_flat_total_label": f"총 {_format_manwon_number(myungsung_execution_cost)}만원",
        "eviction_flat_total_paren_label": f"(총 {_format_manwon_number(myungsung_execution_cost)}만원)",
